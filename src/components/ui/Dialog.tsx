...
import { Root, Trigger, Portal, Content, Overlay, Close, Title, Description } from "@radix-ui/react-dialog";
...
const DialogTitle = React.forwardRef<React.ElementRef<typeof Overlay>, React.ComponentPropsWithoutRef<typeof Overlay>>(
  ({ className, ...props }, ref) => (
